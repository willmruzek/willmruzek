...
export function ResumeContent({ resume }: { resume: Resume }) {
  ...
  return (
    <div>
      {/* Header */}
      <header className="x:mb-[calc(var(--tw-baseline-unit-value-px)*1.5)] x:border-b x:border-gray-300 x:pb-(--tw-baseline-unit-value-px) x:dark:border-gray-600 x:print:mb-6 x:print:pb-6">
        <div className="x:flex x:items-start x:justify-between x:gap-4">
          <div>
            ...
            <p className="x:mt-[calc(var(--tw-baseline-unit-value-px)*0.5)] x:text-base x:text-gray-500 x:dark:text-gray-400 x:print:mt-2 x:print:text-sm">
              {headline}
            </p>
          </div>
        ...
        <div className="x:mt-[calc(var(--tw-baseline-unit-value-px)*0.5)] x:flex x:items-center x:justify-between x:gap-4 x:print:mt-2">
      ...
      {/* Summary */}
      <section className="x:mb-[calc(var(--tw-baseline-unit-value-px)*1.5)] x:print:mb-6">
        <h2 className="x:mb-[calc(var(--tw-baseline-unit-value-px)*0.5)] x:text-xs x:font-semibold x:tracking-widest x:text-gray-500 x:uppercase x:dark:text-gray-400 x:print:mb-3">
          Summary
        </h2>
